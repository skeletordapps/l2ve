      ...
      >
        ...
        <div className="flex flex-col max-w-[716px] z-20">
          ...
          <div className="flex flex-col gap-20 font-medium text-[20px] text-blue-love dark:text-dark-love mt-[40px]">
            ...
            <div className="flex items-center py-3 px-12 shadow-lg rounded-[20px] bg-white dark:bg-[#11151E] text-center ml-[-100px] max-w-[780px] gap-10 relative">
              ...
              <div className="absolute top-2 right-2 w-8 h-8 text-green-400">
                <svg
                  data-slot="icon"
                  fill="currentColor"
                  viewBox="0 0 24 24"
            ...
            <div className="flex items-center py-3 px-12 shadow-lg rounded-[20px] bg-white dark:bg-[#11151E] text-center ml-[-180px] max-w-[780px] gap-16 relative">
      ...
      >
        <div className="flex flex-col z-20">
          ...
          <div className="flex flex-col gap-6 sm:gap-10 font-medium text-[16px] sm:text-[20px] text-blue-love dark:text-dark-love mt-[40px]">
            ...
            <div className="flex flex-col sm:flex-row items-center py-3 sm:px-8 shadow-lg rounded-[20px] bg-white dark:bg-[#11151E] sm:text-center gap-4 sm:gap-10 relative">
              <div className="flex items-center justify-center">
                <Image
                  src="/jerrycan.svg"
                  alt="jerrycan"
