...
export default function Footer() {
  ...
  return (
    <div className="font-medium flex flex-col text-white border-t-2 py-16 sm:py-24 sm:pb-[200px] mt-24 w-full px-6 sm:px-[80px] md:px-12 xl:px-[160px] gap-10 dark:bg-black/30">
